...
def test_shadow_pre_healthy_counterfactual(tmp_path):
    """write_shadow_variants:3 变体落盘;pre_healthy 的召回不含 healthy 标。"""
    import sys
    ...
    scored = composite_score(synth_universe(300), _PRIOR_WEIGHTS)
    ...
    assert set(names) == {"nostrat", "nocap", "pre_healthy"}
