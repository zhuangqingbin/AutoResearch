...
- **市场(market.md)**：**先市场环境 → 再个股技术 → 判共振/背离**。
  ...
  - **② 个股技术**：菜单选 ≤8 个互补指标(close_50_sma,200_sma,10_ema, macd+macds+macdh, rsi, boll+ub+lb, atr, vwma);以验证快照为真值。**(A股)tushare `stk_factor_pro` 现给真·多头排列/RSI6/MACD(前复权),不再靠 60日代理**。**实证警示(factor_lab 全市场回测)**:量比/换手高 ≠ 强势(常是放量滞涨/派发,对次日收益**负**相关),别把单日放量当突破;主力净流入是 **1–2 周 swing 信号**(对次日近中性、对 T+5/10 才显著),别当即时看涨催化。
